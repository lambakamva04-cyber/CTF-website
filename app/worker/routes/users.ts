...
import { writeAudit, type UserRow } from '../lib/db';
...
export async function handleCreateTeamMember(
  ...
  // The temporary password is returned once, in this response, and never stored
  // in readable form. The account cannot be used until it is changed.
